...
public class RouterTimeDiffQuestion extends Question {
  ...
  @JsonCreator
  private static RouterTimeDiffQuestion create(
      @JsonProperty(PROP_NODES) @Nullable String nodes,
      @JsonProperty(PROP_IGNORED_PREFIX_RANGES) @Nullable String ignored) {
    return new RouterTimeDiffQuestion(nodes, ignored);
  }

  public RouterTimeDiffQuestion(@Nullable String nodes, @Nullable String ignored) {
