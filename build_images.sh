...
rm -r ${ASSETS_FULL_PATH}
mkdir ${ASSETS_FULL_PATH}
...
cp projects/allinone/target/allinone-bundle-${BATFISH_VERSION}.jar ${ASSETS_FULL_PATH}/allinone-bundle.jar
cp -r questions ${ASSETS_FULL_PATH}
